...
import {selectCheck,getLeads,multiRemoveSearch,multiAddSearch,multiEditSearch}  from '../actions';
...
test('State test', () => {
  expect(initialSearch).toEqual(searchReducer( initialSearch,multiAddSearch('sic',123)));
